...
- **OCR**: Tesseract OCR
- **Route Optimization**: OR-Tools (Google)
...
3. (Optional) Set up OpenAI API key for advanced AI features:
```bash
...
- Route optimization uses OR-Tools (open-source) with fallback to simple nearest-neighbor algorithm
